...
/*   ~BaseConstraintHandler(){}; */
/*    virtual bool violate_constraints(const dtest_case &test_case) { return
 * false; } */
...
class GecodeConstraintSpace : public Gecode::Space {
 public:
  ...
  GecodeConstraintSpace(const std::vector<int> ranges,
  ...
  GecodeConstraintSpace(bool share, GecodeConstraintSpace& c)
      : Gecode::Space(share, c) {
  ...
  void print() const { std::cout << vars_ << std::endl; }
};
...
class GecodeConstraintHandler : public BaseConstraintHandler {
 ...
 public:
  GecodeConstraintHandler(std::vector<int>& ranges,
                          std::vector<std::vector<int>>& constraints)
      : params(ranges), constraints(constraints) {}
